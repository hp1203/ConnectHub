...
<section className="flex flex-col items-center justify-center p-10 text-gray-700 md:p-20">
	...
	<div className="flex flex-wrap items-center justify-center w-full max-w-4xl mt-8">
		<div className="flex flex-col flex-grow overflow-hidden bg-white rounded-lg shadow-lg">
		...
		<div className="z-10 flex flex-col flex-grow overflow-hidden transform bg-white rounded-lg shadow-lg md:scale-110">
			<div className="flex flex-col items-center p-10 bg-gray-200">
