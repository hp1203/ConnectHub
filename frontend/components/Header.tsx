    ...
    <header className="fixed flex w-full bg-gray-50 z-[99999]">
      <div className="container mx-auto py-6 md:flex md:justify-between md:items-center">
        ...
        <div className="hidden md:flex items-center justify-end">
          <Link href="/auth" className="whitespace-nowrap text-base font-medium text-gray-500 hover:text-gray-900">
            Sign in
          </Link>
          <Link href="/auth/register" className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-500 hover:bg-blue-600 transition duration-150">
            Sign up
          </Link>
        </div>
      </div>
