    ...
    <section className="h-screen pt-24 pb-16">
        <div className="container flex-col md:flex-row mx-auto h-full rounded-xl px-12 py-3 border flex bg-gradient-to-r from-teal-100 to-blue-100">
            <div className="flex flex-1 flex-col justify-center">
                ...
                <button className="bg-blue-500 w-fit text-white text-lg px-6 py-3 rounded-lg shadow-lg hover:bg-blue-600">Get Started</button>
                <Button type="outline">
                    <span className='text-lg'>Hiii</span>
                </Button>
            </div>
